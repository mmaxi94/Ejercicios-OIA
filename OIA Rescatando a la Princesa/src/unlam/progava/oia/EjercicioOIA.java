...
public class EjercicioOIA {
	...
	public static void main(String[] args) {
		...
		ejercicio.leer("src/unlam/progava/oia/in/ejercicio.in");
		ejercicio.resolver();
		ejercicio.escribir("src/unlam/progava/oia/out/ejercicio.out");
	}
	...
	public void escribir(String path) {
		try {
			GestorArchivo.escribirArchivo(path, grafo.getListaCaminofinal(), grafo.getMensaje());
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
